...
public class UserRepository implements Repository<User> {
    public User create(User newUser) throws SQLException {
        ...
        try {
            ...
            DBConnectionManager.close(connection, statement, null);//사용한 리소스 반환
        }
    }
    ...
    public User findById(Integer userId) throws SQLException {
        ...
        try {
            ...
            DBConnectionManager.close(connection, statement, rs);//사용한 리소스 반환
        }
    }

    public void update(Integer id, User newUser) throws SQLException {
        Connection connection = null;
        PreparedStatement statement = null;
